...
#define errIsoMask    	        0x000F0000
#define errIsoBase              0x0000FFFF
...
#define pdu_type_CR    0xE0  // Connection request
#define pdu_type_CC    0xD0  // Connection confirm
#define pdu_type_DR    0x80  // Disconnect request
#define pdu_type_DC    0xC0  // Disconnect confirm
#define pdu_type_DT    0xF0  // Data transfer
...
#pragma pack()
	...
	void TIsoTcpSocket_ErrIsoText(int Error, char *Msg, int len);
...
//	int TIsoTcpSocket_isoExchangePDU(PIsoDataPDU Data);
	...
	//void TIsoTcpSocket_IsoPeek(void *pPDU, TPDUKind &PduKind);
